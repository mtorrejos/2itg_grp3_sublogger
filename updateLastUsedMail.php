...
<body>
    <center class="wrapper">
        <table class="main" width="100%">
            ...
            <tr class="imgSection">
                <td><table><tr>
                    <td><h1 style="font-size:30px; color:#0d6efd; font-weight:900; padding:20px; margin:0; text-align:center; filter: drop-shadow(2px 2px 20px rgba(0,0,0,0.3)) drop-shadow(-2px -2px 20px rgba(0,0,0,0.3));">Reminder</h1></td>
                </tr></table></td>
            </tr>
            <!--BODY-->
